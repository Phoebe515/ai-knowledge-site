...
const updateTime = ref('2026年05月12日 07:00')
const hotNews = ref([
  { title: '罗宾汉乘AI热潮，筹备二度IPO', desc: 'TechCrunch', date: '2026-05-12' },
  { title: '通用汽车裁员招AI强人', desc: 'TechCrunch', date: '2026-05-12' },
  { title: 'Digg再试AI新闻聚合', desc: 'TechCrunch', date: '2026-05-12' }
])
</script>
