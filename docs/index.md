...
const updateTime = ref('2026年04月27日 07:00')
const hotNews = ref([
  { title: '硅谷豪宅需Anthropic股权购买', desc: 'TechCrunch', date: '2026-04-27' },
  { title: 'Anthropic打造智能交易测试市场', desc: 'TechCrunch', date: '2026-04-27' },
  { title: '缅因州长否决数据中心禁令', desc: 'TechCrunch', date: '2026-04-27' }
])
</script>
