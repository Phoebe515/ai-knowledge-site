...
const updateTime = ref('2026年07月17日 07:00')
const hotNews = ref([
  { title: '谷歌视频：AI视频让你当主角', desc: 'TechCrunch', date: '2026-07-17' },
  { title: 'Roblox手机应用推AI游戏创作功能', desc: 'TechCrunch', date: '2026-07-17' },
  { title: '谷歌AI模式可连接互动选应用', desc: 'TechCrunch', date: '2026-07-17' }
])
</script>
