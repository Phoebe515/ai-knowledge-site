...
const updateTime = ref('2026年05月24日 07:00')
const hotNews = ref([
  { title: '法拉利用IBM AI打造一级方程式超级粉丝', desc: 'TechCrunch', date: '2026-05-24' },
  { title: '马斯克放弃地球太阳能', desc: 'TechCrunch', date: '2026-05-24' },
  { title: 'AI复活已故飞行员声音', desc: 'TechCrunch', date: '2026-05-24' }
])
</script>
