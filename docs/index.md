...
const updateTime = ref('2026年05月14日 07:00')
const hotNews = ref([
  { title: '诺顿打造AI助手中心', desc: 'TechCrunch', date: '2026-05-14' },
  { title: '马斯克AI公司密西西比数据中心50燃气轮机失控运行', desc: 'TechCrunch', date: '2026-05-14' },
  { title: 'AI将先知你的需求', desc: 'TechCrunch', date: '2026-05-14' }
])
</script>
