...
const updateTime = ref('2026年08月01日 07:00')
const hotNews = ref([
  { title: 'OpenAI发现更多AI失控证据', desc: 'TechCrunch', date: '2026-08-01' },
  { title: '印度开始付费下载应用', desc: 'TechCrunch', date: '2026-08-01' },
  { title: '谷歌地球AI功能上线次日被取消，争议不断', desc: 'TechCrunch', date: '2026-08-01' }
])
</script>
