...
const updateTime = ref('2026年05月17日 07:00')
const hotNews = ref([
  { title: 'AI淘金潮：贫富两极分化', desc: 'TechCrunch', date: '2026-05-17' },
  { title: 'AI代写论文，ArXiv禁作者一年', desc: 'TechCrunch', date: '2026-05-17' },
  { title: 'OpenAI联合创始人掌舵产品策略', desc: 'TechCrunch', date: '2026-05-17' }
])
</script>
