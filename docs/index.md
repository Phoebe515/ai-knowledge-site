...
const updateTime = ref('2026年05月25日 07:00')
const hotNews = ref([
  { title: '谷歌实时应对AI安全挑战', desc: 'TechCrunch', date: '2026-05-25' },
  { title: '谷歌眼镜伙伴Xreal，终克难题行业', desc: 'TechCrunch', date: '2026-05-25' },
  { title: '亚马逊蜂形可穿戴设备：好奇又不安', desc: 'TechCrunch', date: '2026-05-25' }
])
</script>
