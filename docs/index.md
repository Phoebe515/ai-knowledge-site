...
const updateTime = ref('2026年04月17日 07:00')
const hotNews = ref([
  { title: '工厂估值15亿建企业AI编程', desc: 'TechCrunch', date: '2026-04-17' },
  { title: 'Luma推AI制作室，聚焦信仰项目', desc: 'TechCrunch', date: '2026-04-17' },
  { title: 'AI公司估值20亿，融资洽谈中', desc: 'TechCrunch', date: '2026-04-17' }
])
</script>
