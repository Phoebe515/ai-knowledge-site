...
const updateTime = ref('2026年05月26日 07:00')
const hotNews = ref([
  { title: 'ClickUp裁员看未来职场', desc: 'TechCrunch', date: '2026-05-26' },
  { title: '教皇AI通谕非AI主题', desc: 'TechCrunch', date: '2026-05-26' },
  { title: '创业战场200项目报名截止，5月27日前申请', desc: 'TechCrunch', date: '2026-05-26' }
])
</script>
