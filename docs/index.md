...
const updateTime = ref('2026年09月17日 07:00')
const hotNews = ref([
  { title: 'AI巨头欲设安全评估，独立否？', desc: 'TechCrunch', date: '2026-09-17' },
  { title: 'Meta 准备卖无摄像眼镜', desc: 'TechCrunch', date: '2026-09-17' },
  { title: 'AI实验室先关好门再请审计员', desc: 'TechCrunch', date: '2026-09-17' }
])
</script>
