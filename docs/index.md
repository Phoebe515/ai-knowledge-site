...
const updateTime = ref('2026年08月29日 07:00')
const hotNews = ref([
  { title: '新云Lambda借10亿购芯片', desc: 'TechCrunch', date: '2026-08-29' },
  { title: 'AI研究员展示自我改进AI', desc: 'TechCrunch', date: '2026-08-29' },
  { title: 'AI巨头成硅谷抢购热门', desc: 'TechCrunch', date: '2026-08-29' }
])
</script>
