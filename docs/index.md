...
const updateTime = ref('2026年05月10日 07:00')
const hotNews = ref([
  { title: '印度语音AI挑战大，Wispr Flow仍押注', desc: 'TechCrunch', date: '2026-05-10' },
  { title: '破解AI术语迷思', desc: 'TechCrunch', date: '2026-05-10' },
  { title: '英伟达今年已投40亿布局AI', desc: 'TechCrunch', date: '2026-05-10' }
])
</script>
