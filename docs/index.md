...
const updateTime = ref('2026年09月19日 07:00')
const hotNews = ref([
  { title: '初创公司造初创公司，融10亿押注物理AI', desc: 'TechCrunch', date: '2026-09-19' },
  { title: 'Anthropic开展生物实验', desc: 'TechCrunch', date: '2026-09-19' },
  { title: 'AI幻觉险引美军行动', desc: 'TechCrunch', date: '2026-09-19' }
])
</script>
