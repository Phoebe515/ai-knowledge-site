...
const updateTime = ref('2026年04月13日 07:00')
const hotNews = ref([
  { title: '特朗普官员鼓励银行测试Anthropic神话模型', desc: 'TechCrunch', date: '2026-04-13' },
  { title: '苹果测试四款智能眼镜设计', desc: 'TechCrunch', date: '2026-04-13' },
  { title: 'AI术语速查指南', desc: 'TechCrunch', date: '2026-04-13' }
])
</script>
