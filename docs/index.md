...
const updateTime = ref('2026年05月30日 07:00')
const hotNews = ref([
  { title: '程序员拒用AI，反遭报复？', desc: 'TechCrunch', date: '2026-05-30' },
  { title: '破解AI术语迷思', desc: 'TechCrunch', date: '2026-05-30' },
  { title: '企业过度依赖AI会怎样？', desc: 'TechCrunch', date: '2026-05-30' }
])
</script>
