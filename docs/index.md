...
const updateTime = ref('2026年07月20日 07:00')
const hotNews = ref([
  { title: '黄仁勋访日关注点', desc: 'TechCrunch', date: '2026-07-20' },
  { title: '苹果诉讼或阻挠OpenAI硬件计划', desc: 'TechCrunch', date: '2026-07-20' },
  { title: '《奥德赛》导演称AI是明显的“特洛伊木马”', desc: 'TechCrunch', date: '2026-07-20' }
])
</script>
