...
const updateTime = ref('2026年06月18日 07:00')
const hotNews = ref([
  { title: '罗洛夫·博塔加入SpaceX董事会', desc: 'TechCrunch', date: '2026-06-18' },
  { title: 'Snap发布天价AR眼镜，股价大跌', desc: 'TechCrunch', date: '2026-06-18' },
  { title: '企业AI投资回报仍待解', desc: 'TechCrunch', date: '2026-06-18' }
])
</script>
