...
const updateTime = ref('2026年09月20日 07:00')
const hotNews = ref([
  { title: '员工股权激励缩编员工', desc: 'TechCrunch', date: '2026-09-20' },
  { title: '特朗普提议：给AI换新名，建AI部队', desc: 'TechCrunch', date: '2026-09-20' },
  { title: '谷歌Gemini成AI黑客新宠', desc: 'TechCrunch', date: '2026-09-20' }
])
</script>
