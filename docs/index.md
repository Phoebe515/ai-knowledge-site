...
const updateTime = ref('2026年08月25日 07:00')
const hotNews = ref([
  { title: 'AI对冲基金被SEC调查', desc: 'TechCrunch', date: '2026-08-25' },
  { title: '特朗普IPO后两周购SpaceX股', desc: 'TechCrunch', date: '2026-08-25' },
  { title: '亚马逊硬件涨60%，称内存短缺', desc: 'TechCrunch', date: '2026-08-25' }
])
</script>
