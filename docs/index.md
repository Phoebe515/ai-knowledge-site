...
const updateTime = ref('2026年07月19日 07:00')
const hotNews = ref([
  { title: '基米：威胁还是威胁？', desc: 'TechCrunch', date: '2026-07-19' },
  { title: 'AI投资热潮将回归', desc: 'TechCrunch', date: '2026-07-19' },
  { title: 'Vertu AI助手售价6880美元，实际表现如何？', desc: 'TechCrunch', date: '2026-07-19' }
])
</script>
