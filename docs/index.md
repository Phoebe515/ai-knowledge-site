...
const updateTime = ref('2026年08月11日 07:00')
const hotNews = ref([
  { title: 'OpenAI完成70亿员工收购提议', desc: 'TechCrunch', date: '2026-08-11' },
  { title: 'AI攻击增多，OpenAI发布新模型', desc: 'TechCrunch', date: '2026-08-11' },
  { title: '扎克伯格AI宣言引反感', desc: 'TechCrunch', date: '2026-08-11' }
])
</script>
