...
const updateTime = ref('2026年07月07日 07:00')
const hotNews = ref([
  { title: '首例AI勒索软件攻击仍需人力', desc: 'TechCrunch', date: '2026-07-07' },
  { title: '美投资者将迎AI热潮新内存巨头', desc: 'TechCrunch', date: '2026-07-07' },
  { title: 'Vercel CEO谈模型与代理分离之争', desc: 'TechCrunch', date: '2026-07-07' }
])
</script>
