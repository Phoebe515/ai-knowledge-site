...
const updateTime = ref('2026年4月7日 07:00')
const hotNews = ref([
  { title: 'GPT-5即将发布', desc: 'OpenAI新一代模型突破', date: '2026-04-07' },
  { title: 'Sora视频生成', desc: 'AI视频生成重大突破', date: '2026-04-07' },
  { title: 'Claude 3发布', desc: 'Anthropic最新模型', date: '2026-04-06' }
])
</script>
