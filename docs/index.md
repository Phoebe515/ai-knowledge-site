...
const updateTime = ref('2026年06月23日 07:00')
const hotNews = ref([
  { title: '2026年AI裁员潮一览', desc: 'TechCrunch', date: '2026-06-23' },
  { title: 'OpenAI推新计划修复开源漏洞', desc: 'TechCrunch', date: '2026-06-23' },
  { title: 'AI界陷入“循环迷局”', desc: 'TechCrunch', date: '2026-06-23' }
])
</script>
