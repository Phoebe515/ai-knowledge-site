...
const updateTime = ref('2026年08月15日 07:00')
const hotNews = ref([
  { title: '谷歌AI生成内容可移除水印', desc: 'TechCrunch', date: '2026-08-15' },
  { title: '扎克伯格真信AI“人人可用”？', desc: 'TechCrunch', date: '2026-08-15' },
  { title: 'Kog深度挖掘GPU推理潜能', desc: 'TechCrunch', date: '2026-08-15' }
])
</script>
