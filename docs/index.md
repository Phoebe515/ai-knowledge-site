...
const updateTime = ref('2026年05月04日 07:00')
const hotNews = ref([
  { title: 'AI初创公司盗用“这是好的”创作者艺术', desc: 'TechCrunch', date: '2026-05-04' },
  { title: '哈佛研究：AI诊断胜过两位医生', desc: 'TechCrunch', date: '2026-05-04' },
  { title: 'AI演员剧本无缘奥斯卡', desc: 'TechCrunch', date: '2026-05-04' }
])
</script>
