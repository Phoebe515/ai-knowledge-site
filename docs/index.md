...
const updateTime = ref('2026年09月14日 07:00')
const hotNews = ref([
  { title: 'AI行业最新末日警告背后何在？', desc: 'TechCrunch', date: '2026-09-14' },
  { title: '奥巴马吁民主党制定AI安全计划', desc: 'TechCrunch', date: '2026-09-14' },
  { title: 'AI巨头CEO：2026年上市不妥', desc: 'TechCrunch', date: '2026-09-14' }
])
</script>
